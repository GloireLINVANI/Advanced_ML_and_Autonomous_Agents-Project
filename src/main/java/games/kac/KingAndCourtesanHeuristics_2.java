...
public class KingAndCourtesanHeuristics_2 {

    private static final int H_PIECES_DIFF = 20;
    private static final int H_POSSIBLE_MOVES_DIFF = 5;
    private static final int H_POTENTIAL_CAPTURE = 10;
    private static final int H_DIST_KING = 100;
    private static final int H_CLOSE_TO_VICTORY = 1000;
