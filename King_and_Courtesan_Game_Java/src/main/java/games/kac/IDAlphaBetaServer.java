...
public class IDAlphaBetaServer {
    ...
    private static String agentType = "ID Alpha-Beta";
    ...
    private static class ClientHandler implements Runnable {
        ...
        private GameAlgorithm<KingAndCourtesanMove, KingAndCourtesanRole, KingAndCourtesanBoard> redAlgorithm_id_alpha_beta;
        private GameAlgorithm<KingAndCourtesanMove, KingAndCourtesanRole, KingAndCourtesanBoard> blueAlgorithm_id_alpha_beta;
        private GameAlgorithm<KingAndCourtesanMove, KingAndCourtesanRole, KingAndCourtesanBoard> redAlgorithm_alpha_beta;
        private GameAlgorithm<KingAndCourtesanMove, KingAndCourtesanRole, KingAndCourtesanBoard> blueAlgorithm_alpha_beta;
        ...
        private void initializeAlgorithms() {
            ...
            if (agentType.equals("ID Alpha-Beta")) {

                redAlgorithm_id_alpha_beta = new IDAlphaBeta<>(KingAndCourtesanRole.RED, KingAndCourtesanRole.BLUE, KingAndCourtesanHeuristics.hRed, searchDepth, timeLimit);

                blueAlgorithm_id_alpha_beta = new IDAlphaBeta<>(KingAndCourtesanRole.BLUE, KingAndCourtesanRole.RED, KingAndCourtesanHeuristics.hBlue, searchDepth, timeLimit);
            } else if (agentType.equals("Alpha-Beta")) {
                redAlgorithm_alpha_beta = new AlphaBeta<>(KingAndCourtesanRole.RED, KingAndCourtesanRole.BLUE, KingAndCourtesanHeuristics.hRed, searchDepth);

                blueAlgorithm_alpha_beta = new AlphaBeta<>(KingAndCourtesanRole.BLUE, KingAndCourtesanRole.RED, KingAndCourtesanHeuristics.hBlue, searchDepth);
            } else {
                throw new IllegalArgumentException("Invalid agent type: " + agentType);
            }

            System.out.println("Using " + agentType + " algorithm");
        }
        ...
        private JSONObject handleCommand(JSONObject command) throws Exception {
            ...
            switch (cmd) {
                ...
                case "GET_BEST_MOVE":
                    ...
                    if (agentType.equals("ID Alpha-Beta")) {
                        algorithm = (requestedRole == KingAndCourtesanRole.RED) ? redAlgorithm_id_alpha_beta : blueAlgorithm_id_alpha_beta;
                    } else {
                        algorithm = (requestedRole == KingAndCourtesanRole.RED) ? redAlgorithm_alpha_beta : blueAlgorithm_alpha_beta;
                    }
                ...
                case "SET_PARAMETERS":
                    ...
                    if (command.has("max_depth")) {
                        searchDepth = command.getInt("max_depth");
                        response.put("max_depth", searchDepth);
                    }
                    ...
                    if (command.has("agent_type")) {
                        agentType = command.getString("agent_type");
